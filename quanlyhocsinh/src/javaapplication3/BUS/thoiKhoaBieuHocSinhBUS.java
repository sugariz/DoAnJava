...
import javaapplication3.DAO.thoiKhoaBieuHocSinhDAO;
 ...
 * @author phongdiep
 */
public class thoiKhoaBieuHocSinhBUS {

    public static ArrayList<thoiKhoaBieuHocSinhDTO> listThoiKhoaBieu = null;

    public thoiKhoaBieuHocSinhBUS() {
    }

    public ArrayList<ArrayList<Object>> getThoiKhoaBieuHocSinh(String maLop, String maNamHoc, String maHocKy) {
...
//            tiet = arrayTiet[]
    ...
    public void build(String maLop) {
        if (listThoiKhoaBieu == null) {
            listThoiKhoaBieu = new thoiKhoaBieuHocSinhDAO().getThoiKhoaBieu(maLop);
        }
    }
}
