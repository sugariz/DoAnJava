...
import javaapplication3.BUS.LoginBUS;
//import Add.*;
...
//    }//GEN-LAST:event_jLabelRegisterMouseClicked
    ...
    private void jButton_LOGINActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LOGINActionPerformed
        ...
        String query = "SELECT * FROM `register_user` WHERE `u_uname` =? AND `u_pass` =?";
        LoginBUS login = new LoginBUS();
        int check = login.getAccount(uname, pass);
        switch(check){
            case 1:
                JOptionPane.showMessageDialog(null, "Chào admin", "Login", 2);
//                AddClass second = new AddClass();
...
//                dispose();
                break;
            case 2:
                JOptionPane.showMessageDialog(null, "Hello Teacher", "Login", 2);
                break;
             case 3:
                JOptionPane.showMessageDialog(null, "Chào boạn nhân viên", "Login", 2);
                break;
             case 4:
                JOptionPane.showMessageDialog(null, "Chào chó đỏ", "Login", 2);
                break;
             default:
                JOptionPane.showMessageDialog(null, "Tài khoản hoặc mật bạn không đúng!", "Login Failed", 2); 
                break;
        }
        System.err.println(check);
        
//        try {
////            ps = MyConnection.getConnection("jdbc:mysql://localhost:3306/login_u","root","").prepareStatement(query);
//            
