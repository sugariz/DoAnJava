...
import java.io.File;
import javaapplication3.GUI.AddTeacher;
import javaapplication3.GUI.addStudentGUI;
import javaapplication3.GUI.inputScoreGUI;
import javax.swing.border.EmptyBorder;
import javaapplication3.GUI.scoreGUI;
import javaapplication3.GUI.thoiKhoaBieuGiaoVienGUI;
import javaapplication3.GUI.thoiKhoaBieuHocSinhGUI;
...
public class NewClass1 extends JFrame {
    ...
    public NewClass1(String type) throws Exception {
        gPermission = type;
        this.build();
        this.pack();
    ...
    private void buildBodyLayout() throws Exception {
        ...
        if(this.gPermission == "admin") {
            new inputScoreGUI(this.maGv, scoreLayout);
            new thoiKhoaBieuGiaoVienGUI(this.maGv, scheduleLayout);
            new addStudentGUI(homeLayout);
            new AddTeacher(aboutLayout);
        }
        else {
            new scoreGUI(scoreLayout, this.MAHS);
            new thoiKhoaBieuHocSinhGUI(this.maLop, scheduleLayout);
//            new statisticalGUI(homeLayout);
        }
    ...
    private void buildTitleMenu() {
        ...
        javax.swing.JLabel labelTitleHome = new JLabel(gPermission.equals("admin") ? "Thêm học sinh" : "");
        javax.swing.JLabel labelTitleSchedule = new JLabel("Thời khóa biểu");
        javax.swing.JLabel labelTitleScore = new JLabel("Điểm");
        javax.swing.JLabel labelTitleAbout = new JLabel(gPermission.equals("admin") ? gPermission.equals("admin") ? "Thêm học sinh" : "" : "");
//        javax.swing.JLabel labelTitlStatistical = new JLabel("Thống kê");
...
//        panelTitleAbout.setBorder(new javax.swing.border.EmptyBorder(0, 10, 0, 0));
    ...
    private String gPermission = "user";
    private String maLop = "LOP1011920";
